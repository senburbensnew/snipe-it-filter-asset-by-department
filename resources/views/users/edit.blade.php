        ...
        <div class="col-md-8 col-md-offset-2">
            <form class="form-horizontal" method="post" autocomplete="off"
                ...
                <div class="nav-tabs-custom">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group {{ $errors->has('username') ? 'has-error' : '' }}">
                                        <label class="col-md-3 control-label"
                                            for="username">{{ trans('admin/users/table.username') }}</label>
                                        ...
                                        @if (config('app.lock_passwords') && $user->id)
                                            ...
                                            <div class="col-md-8 col-md-offset-3">
                                                <p class="text-warning"><x-icon type="lock" />
                                    ...
                                    <div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            @if ($user->ldap_import != '1' || str_contains(Route::currentRouteName(), 'clone'))
                                                <input type="password" name="password" class="form-control" id="password"
                                                    value="" maxlength="500" autocomplete="off" readonly
                                        ...
                                        <div class="col-md-2">
                                            @if ($user->ldap_import != '1')
                                                <a href="#" class="left"
                                                    id="genPassword">{{ trans('general.generate') }}</a>
                                            @endif
                                        </div>
                                    </div>
                                        ...
                                        <div
                                            ...
                                            <div class="col-md-6">
                                                <input type="password" name="password_confirmation" id="password_confirm"
                                                    class="form-control" value="" maxlength="500" autocomplete="off"
                                                    aria-label="password_confirmation" readonly
                                                    {{ !$user->id ? ' required' : '' }}
                                                    onfocus="this.removeAttribute('readonly');"
                                                    {{ config('app.lock_passwords') && $user->id ? ' disabled' : '' }}>
                                                @if (config('app.lock_passwords') && $user->id)
                                                    <p class="help-block">{{ trans('admin/users/table.lock_passwords') }}
                                                    </p>
                                                @endif
                                        ...
                                        <div class="col-md-9 col-md-offset-3">
                                            ...
                                            @if (config('app.lock_passwords'))
                                                ...
                                                <label class="form-control form-control--disabled">
                                                    <input type="checkbox" value="1" name="activated" class="disabled"
                                                        {{ old('activated', $user->activated) == '1' ? ' checked="checked"' : '' }}
                                                        disabled="disabled" aria-label="activated">
                                            ...
                                            @elseif ($user->id === Auth::user()->id)
                                                ...
                                                <p class="text-warning">
                                                    {{ trans('admin/users/general.activated_disabled_help_text') }}</p>
                                            @else
                                                <!-- everything is normal - as you were -->
                                                <label class="form-control">
                                                    <input type="checkbox" value="1"
                                                        name="activated"{{ old('activated') == '1' || $user->activated == '1' ? ' checked="checked"' : '' }}
                                                        aria-label="activated" id="activated">
                                                    {{ trans('admin/users/general.activated_help_text') }}
                                                </label>
                                            @endif
                                    ...
                                    <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                                        <label class="col-md-3 control-label"
                                            for="email">{{ trans('admin/users/table.email') }} </label>
                                        <div class="col-md-6">
                                            <input class="form-control" type="text" name="email" id="email"
                                                maxlength="191" value="{{ old('email', $user->email) }}"
                                                {{ config('app.lock_passwords') && $user->id ? ' disabled' : '' }}
                                    ...
                                    @if (!$user->id)
                                        <div class="form-group" id="email_user_row">
                                            ...
                                            <div class="col-md-8 col-md-offset-3">
                                                ...
                                                <p class="help-block"> {{ trans('admin/users/general.send_email_help') }}
                                                </p>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="optional_user_details" class="col-md-12" style="display:none">
                                            ...
                                            <div class="form-group {{ $errors->has('locale') ? 'has-error' : '' }}">
                                                <label class="col-md-3 control-label"
                                                    for="locale">{{ trans('general.language') }}</label>
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-group {{ $errors->has('employee_num') ? 'has-error' : '' }}">
                                                <label class="col-md-3 control-label"
                                                    for="employee_num">{{ trans('general.employee_number') }}</label>
                                                <div class="col-md-6">
                                                    <input class="form-control" type="text" aria-label="employee_num"
                                                        name="employee_num" maxlength="191" id="employee_num"
                                            ...
                                            <div class="form-group {{ $errors->has('jobtitle') ? 'has-error' : '' }}">
                                                <label class="col-md-3 control-label"
                                                    for="jobtitle">{{ trans('admin/users/table.title') }}</label>
                                                <div class="col-md-6">
                                                    <input class="form-control" type="text" maxlength="191"
                                            ...
                                            @include ('partials.forms.edit.user-select', [
                                                'translated_name' => trans('admin/users/table.manager'),
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-7 col-md-offset-3">
                                                    ...
                                                    <label class="form-control" for="vip">
                                                        <input type="checkbox" value="1" name="vip"
                                                            {{ old('vip', $user->vip) == '1' ? ' checked="checked"' : '' }}
                                                            aria-label="vip">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-7 col-md-offset-3">
                                                    ...
                                                    <label class="form-control" for="autoassign_licenses">
                                                        <input type="checkbox" value="1" name="autoassign_licenses"
                                                            {{ old('autoassign_licenses', $user->autoassign_licenses) == '1' ? " checked='checked'" : '' }}
                                                            aria-label="autoassign_licenses">
                                                        {{ trans('general.autoassign_licenses') }}
                                                    </label>

                                                    <p class="help-block">
                                                        {{ trans('general.autoassign_licenses_help_long') }}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-7 col-md-offset-3">
                                                    <label for="remote" class="form-control">
                                                        <input type="checkbox" value="1" name="remote"
                                                            {{ old('remote', $user->remote) == '1' ? ' checked="checked"' : '' }}
                                                            aria-label="remote">
                                            ...
                                            <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                                                <label class="col-md-3 control-label"
                                                    for="phone">{{ trans('admin/users/table.phone') }}</label>
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-group {{ $errors->has('website') ? ' has-error' : '' }}">
                                                <label for="website"
                                                    class="col-md-3 control-label">{{ trans('general.website') }}</label>
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                                <label class="col-md-3 control-label"
                                                    for="address">{{ trans('general.address') }}</label>
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                                                <label class="col-md-3 control-label"
                                                    for="city">{{ trans('general.city') }}</label>
                                                <div class="col-md-6">
                                                    <input class="form-control" type="text" name="city"
                                                        id="city" aria-label="city"
                                                        value="{{ old('city', $user->city) }}" maxlength="191" />
                                            ...
                                            <div class="form-group{{ $errors->has('state') ? ' has-error' : '' }}">
                                                <label class="col-md-3 control-label"
                                                    for="state">{{ trans('general.state') }}</label>
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-group{{ $errors->has('country') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <p class="help-block">
                                                        {{ trans('general.countries_manually_entered_help') }}</p>
                                            ...
                                            <div class="form-group{{ $errors->has('zip') ? ' has-error' : '' }}">
                                                <label class="col-md-3 control-label"
                                                    for="zip">{{ trans('general.zip') }}</label>
                                                <div class="col-md-3">
                                            ...
                                            <div class="form-group{!! $errors->has('notes') ? ' has-error' : '' !!}">
                                                <label for="notes"
                                                    class="col-md-3 control-label">{{ trans('admin/users/table.notes') }}</label>
                                                <div class="col-md-6">
                                            ...
                                            @if ($snipeSettings->two_factor_enabled != '')
                                                            ...
                                                            @if (config('app.lock_passwords'))
                                                                <label class="form-control form-control--disabled"
                                                                    ...
                                                                    <input type="checkbox" value="1"
                                                                        ...
                                                                        {{ old('two_factor_optin', $user->two_factor_optin) == '1' ? ' checked="checked"' : '' }}
                                                                        aria-label="two_factor_optin" disabled>
                                                ...
                                                @if (Auth::user()->isSuperUser() &&
                                                        $user->two_factor_active_and_enrolled() &&
                                                        $snipeSettings->two_factor_enabled != '0' &&
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-8 col-md-offset-3 two_factor_resetrow">
                                                            <a class="btn btn-default btn-sm pull-left"
                                                                id="two_factor_reset" style="margin-right: 10px;">
                                                                {{ trans('admin/settings/general.two_factor_reset') }}</a>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    @if ($groups->count())
                                                        @if (Config::get('app.lock_passwords') || !Auth::user()->isSuperUser())
                                                            ...
                                                            <span
                                                                class="help-block">{{ trans('admin/users/general.group_memberships_helpblock') }}</span>
                                                        @else
                                                            <div class="controls">
                                                                <select name="groups[]" aria-label="groups[]"
                                                        ...
                                                        @endif
                                                    @else
                                                        <p>{{ trans('admin/users/table.nogroup') }}
                                                            <code>{{ trans('admin/settings/general.admin_settings') }} <i
                                                                    class="fa fa-cogs"></i> >
                                                                {{ trans('general.groups') }} <i
                                                                    class="fas fa-user-friends"></i></code>
                                                        </p>
                                                    @endif
                            ...
                            <div class="col-md-12">
                                @if (!Auth::user()->isSuperUser())
                                    <p class="alert alert-warning">
                                        {{ trans('admin/users/general.superadmin_permission_warning') }}</p>
                                @endif

                                @if (!Auth::user()->hasAccess('admin'))
                                    <p class="alert alert-warning">
                                        {{ trans('admin/users/general.admin_permission_warning') }}</p>
                                @endif
                            </div>
                    ...
                    <x-redirect_submit_options index_route="users.index" :button_label="trans('general.save')" :options="[
                ...
                $.ajax({
                    ...
                    headers: {
                        ...
                        "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr(
                            'content') // TODO` - we should do this in ajaxSetup
                    },
                    dataType: 'json',
                    ...
                    error: function(data) {
                        $("#two_factor_reseticon").html('');
                        $("#two_factor_resetstatus").html(
                            '<span class="text-danger"><i class="fas fa-exclamation-triangle text-danger"></i> ' +
                            data.message + '</span>');
                    }
